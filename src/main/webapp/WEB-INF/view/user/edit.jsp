        ...
        <section class="content">
            <form class="form-horizontal" role="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-6 col-md-6">
                        <input type="text" class="form-control" placeholder="姓名" name="name" value="${user.name}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-offset-2 col-md-offset-2 col-xs-4 col-sm-2 col-md-2 control-label">邮箱</label>
                    <div class="col-xs-8 col-sm-6 col-md-6">
                        <input type="text" class="form-control" placeholder="example@xxx.com" name="email" value="${user.email}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-6 col-md-6">
                        <c:forEach var="role" items="${roles}">
                            ...
                            <c:forEach items="${user.roles}" var="userRole">
                                <c:if test="${userRole.name eq role.name}">
                            ...
                            <div class="ez checkbox">
                                <label>
                                    <c:if test="${iscontain}">
                                        <input name="userRole" type="checkbox" value="${role.id}" checked>${role.name}
                                    </c:if>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-6 col-md-6">
                        <textarea rows="3" class="form-control" placeholder="备注" name="remarks" value="${user.remarks}"></textarea>
                    </div>
                </div>
                <div class="form-group">
...
<script src="${ctx}/lib/ez/user.edit.js"></script>
