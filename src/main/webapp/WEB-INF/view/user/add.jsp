        ...
        <section class="content">
            <form class="form-horizontal" role="form" method="post">
                <div class="form-group">
                    ...
                    <%--<div class="col-xs-offset-4 col-sm-offset-4 col-md-offset-0 col-xs-8 col-sm-8 col-md-2">
                        <a id="checkUsername" href="javascript:void(0);" style="line-height: 30px;">
                            <span class="glyphicon glyphicon-refresh"></span> 检查是否可用
                        </a>
                    </div>--%>
                </div>
                <div class="form-group">
                    <label class="col-sm-offset-2 col-md-offset-2 col-xs-4 col-sm-2 col-md-2 control-label">姓名</label>
                    <div class="col-xs-8 col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-6 col-md-6">
                        <input type="text" class="form-control" placeholder="example@xxx.com" name="email">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-offset-2 col-md-offset-2 col-xs-4 col-sm-2 col-md-2 control-label">用户角色</label>
                    <div class="col-xs-8 col-sm-6 col-md-6">
                    <c:forEach var="role" items="${roles}">
                        <div class="ez checkbox">
                        <label>
                            <input name="userRole" type="checkbox" value="${role.id}">${role.name}
                        </label>
                        </div>
                    </c:forEach>
                    </div>
...
<script src="${ctx}/lib/ez/user.add.js"></script>
